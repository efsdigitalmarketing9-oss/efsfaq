    ...
    sections: [
      {
        ...
        content: `By accessing and using EFS's services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.

These terms constitute a legally binding agreement between you and EFS. Your continued use of our services indicates your acceptance of any updates or modifications to these terms.`,
      },
      {
...
• Report any security vulnerabilities or suspicious activities`,
      },
      {
        ...
        content: `You are responsible for maintaining the security of your account and password. EFS cannot and will not be liable for any loss or damage from your failure to comply with this security obligation.
    ...
    sections: [
      {
        ...
        content: `EFS provides AI-powered digital solutions and optimization services. Our platform helps businesses improve their online presence and operational efficiency through advanced technology and human expertise.
