        ...
        answer: (
            <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <p>
                    ...
                    In EFS's real system, Lucky Orders are rare and completely random, we can't control or assign them at will.
        ...
        answer: (
            <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
                        ✅ Contact <strong>EFS Customer Support</strong> and tell them you need a{" "}
                ...
                <p>
                    ...
                    guided you through, using the official EFS deposit process.
                </p>
                <p>
        ...
        answer: (
            <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <p>
                    ...
                    remember, your trainer and EFS support are here to guide you step-by-step.
                </p>
                <p>
                ...
                <p>
                    ...
                    That's why our EFS trainers and customer support are dedicated to helping you at every step, making sure
        ...
        answer: (
            <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li>
                        <span className="font-semibold">Contact EFS customer service.</span> Tell them which crypto you bought,
                    ...
                    <li>
                        <span className="font-semibold">Send the receipt + your EFS username to customer service.</span> This
                ...
                <p>
                    ...
                    forward, and if you ever need help, EFS support is here for you.
                </p>
                <p className="text-sm italic text-gray-400">
            ...
            replies: [
                {
                    id: 24,
                    userId: 5, // Lisa Wang
                    text: "Omg I saw those too! Good thing EFS keeps reminding us not to fall for fake versions.",
                    timestamp: "1 hour ago",
                    likes: 4,
                    likedByUser: false,
                },
