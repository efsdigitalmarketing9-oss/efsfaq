...
export default function BitcoinTutorial() {
    ...
    const steps = [
        {
            id: 1,
            title: "Contact EFS Customer Service",
                        ...
                        <div className="relative bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-gray-200/50">
                            <div className="text-center mb-8">
                                ...
                                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                    First, you need to contact EFS customer service to get your unique Bitcoin deposit address.
                                </p>
                            </div>
                                ...
                                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 border border-yellow-200">
                                    ...
                                    <div className="bg-white rounded-xl p-4 shadow-sm border border-yellow-200/50">
                                        <p className="text-gray-800 italic text-lg leading-relaxed">
                                            "Hi, I need Bitcoin deposit address to send Bitcoin to my EFS account. Can you please
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                                        ...
                                        <p className="text-green-800">
                                            Great! You now own Bitcoin in your Cash App. Next, we'll send it to your EFS account.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="relative mb-16">
                        ...
                        <div className="relative bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-gray-200/50">
                            <div className="text-center mb-8">
                                ...
                                <h2 className="text-4xl font-black text-gray-900 mb-4">Step 3: Send Bitcoin to EFS</h2>
                                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                    Now let's send your Bitcoin to the EFS address you received in Step 1.
                                </p>
                            </div>
                            ...
                            <div className="grid lg:grid-cols-2 gap-8 mb-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            Paste the Bitcoin address that EFS customer service gave you in Step 1.
                                        </p>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="bg-orange-50 rounded-xl p-4 border border-orange-200">
                                                    <p className="text-orange-800 text-sm">
                                                        ...
                                                        your Bitcoin to the EFS address.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <p className="text-green-800 text-sm">
                                                            <strong>Success!</strong> Your Bitcoin is now being sent to your EFS account. This
                            ...
                            {isVerified !== null && (
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600 mt-4">
                                        Your Bitcoin should appear in your EFS account within 10-60 minutes.
                                    </p>
                                </div>
                            )}
                        </div>
